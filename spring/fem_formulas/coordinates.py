...
def calculo_coordenadas(d_str,D_str, d1_str, d2_str, L_str, N_str, E1, Luz1_str, vr1_str, E2, Luz2_str, vr2_str):
  ...
  # d1_str = input("Diámetro interior 1: ")
  d1 = float(d1_str)

  # d2_str = input("Diámetro interior 2: ")
  d2 = float(d2_str)
  ...
  # if (E1 == "TASE" or E1 == "TAE"):
    # Luz1_str = input("Luz 1: ")
  Luz_1 = float(Luz1_str)
  # elif (E1 == "TCSE" or E1 == "TCE"):
    # Luz_1 = 0

  # if (d1 > 0):
  #   vr1_str = input("Vueltas reducidas del d1: ")
  vr1 = float(vr1_str)
  # else:
  #   vr1 = 0.0
  ...
  #   Luz2_str = input("Luz 2: ")
  Luz_2 = float(Luz2_str)
  # elif (E2 == "TCSE" or E2 == "TCE"):
    # Luz_2 = 0

  # if (d2 > 0):
  #   vr2_str = input("Vueltas reducidas del d2: ")
  vr2 = float(vr2_str)
  # else:
  #   vr2 = 0.0
  ...
  z_total = []
  ind1 = 0
  while (ind1 < len(coord1_x1)):
    x_total.append(coord1_x1[ind1])
    z_total.append(coord1_z1[ind1])
    y_total.append(coord2_y1[ind1])
    ind1 = ind1 + 1

  ind2 = 1
  while (ind2 < len(coord1_x2)):
    x_total.append(coord1_x2[ind2])
    z_total.append(coord1_z2[ind2])
    y_total.append(coord2_y2[ind2])
    ind2 = ind2 + 1

  ind3 = 1
  while (ind3 < len(coord1_x3)):
    x_total.append(coord1_x3[ind3])
    z_total.append(coord1_z3[ind3])
    y_total.append(coord2_y3[ind3])
    ind3 = ind3 + 1

  ind4 = 1
  while (ind4 < len(coord1_x4)):
    x_total.append(coord1_x4[ind4])
    z_total.append(coord1_z4[ind4])
    y_total.append(coord2_y4[ind4])
    ind4 = ind4 + 1

  ind5 = 1
  while (ind5 < len(coord1_x5)):
    x_total.append(coord1_x5[ind5])
    z_total.append(coord1_z5[ind5])
    y_total.append(coord2_y5[ind5])
    ind5 = ind5 + 1
