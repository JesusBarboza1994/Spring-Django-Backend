"""
Django settings for BackendDesign project.
...
SECRET_KEY = 'django-insecure-dx=ile133t29*ymrftu9=z$_=!^sxk%fvva_&c%0#kxqf5a(rx'
...
WSGI_APPLICATION = 'BackendDesign.wsgi.application'
